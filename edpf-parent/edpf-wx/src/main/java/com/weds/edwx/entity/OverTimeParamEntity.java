...
public class OverTimeParamEntity implements Serializable {
    ...
    @ApiModelProperty(required = true, dataType = "String", example = "00103", value = "加班编号")
    private String bh;

    @ApiModelProperty(required = true, dataType = "String", example = "00103", value = "加班类型")
    private String jblx;
    ...
    @ApiModelProperty(required = true, dataType = "String", example = "200", value = "计算结果")
    private String jsjg;
